...
class ASyncAuthorise(passwordAuth.passwordAuth):
    def __init__(self,parent,keydistObject,url,authorizedKeysFile=None,*args,**kwargs):
        self.parent=parent
        self.kwargs=kwargs
        self.pubkey=None
    ...
    def copyID(self,keyModel,username=None,host=None):
        ...
        destURL='https://portal.synchrotron.org.au:1443/api/v1/oauth/token'
        auth=cvlsshutils.ASyncAuth.ASyncAuth(self.session,destURL,parent=self.parent,**self.kwargs)
